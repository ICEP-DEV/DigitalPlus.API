...
namespace DigitalPlus.Data.Migrations
{
    ...
    [Migration("20250626121359_initial-database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalPlus.API.Model.LearningModule", b =>
                {
            ...
            modelBuilder.Entity("DigitalPlus.Data.Model.MenteeNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalPlus.Data.Model.MentorNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalPlus.Data.Model.Message", b =>
                {
                    b.Property<int>("MessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalPlus.Data.Model.MessageAttachment", b =>
                {
            ...
            modelBuilder.Entity("DigitalPlus.Data.Model.Questions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalPlus.Data.Model.QuizQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalPlus.API.Model.AssignMod", b =>
                {
                    ...
                    b.HasOne("DigitalPlus.API.Model.LearningModule", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("DigitalPlus.Data.Model.MessageAttachment", b =>
                {
                    b.HasOne("DigitalPlus.Data.Model.Message", "Message")
                        .WithMany()
            ...
            modelBuilder.Entity("DigitalPlus.Data.Model.QuizQuestion", b =>
                {
                    b.HasOne("DigitalPlus.Data.Model.Questions", "Quiz")
                        .WithMany("Question")
